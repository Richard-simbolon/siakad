<?php
        ...
        class DosenModel extends Model
        {
            ...
            //protected $fillable = ['id','row_status','nama','nik','tempat_lahir','tanggal_lahir','agama','jenis_kelamin','nidn_nup_nidk','nip','npwp','status','nama_ibu','ikatan_kerja','status_pegawai','jenis_pegawai','no_sk_cpns','tanggal_sk_cpns','no_sk_pengangkatan','tgl_sk_pengangkatan','lembaga_pengangkatan','pangkat_golongan','sumber_gaji','alamat','dusun','kelurahan','kecamatan','rt','rw','kode_pos','telepon','no_hp','email','created_by','created_date','modified_by','modified_dateYour '];
            protected $guarded = [];
