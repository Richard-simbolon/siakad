<?php
        ...
        class RiwayatFungsionalModel extends Model
        {

            protected $table = "dosen_riwayat_fungsional";
            protected $guarded = [];
            ...
            /**************************************/
            public function up(){
                Schema::create("dosen_riwayat_sertifikasi", function (Blueprint $table) {
            ...
            {
                Schema::dropIfExists("dosen_riwayat_sertifikasi");
            }
