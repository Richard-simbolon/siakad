...
class KelasPerkuliahanModel extends Model
{
    ...
    protected $fillable = [
        "id","row_status","program_studi_id","angkatan_id","semester_id", "mata_kuliah_id", "kelas_id", "pembahasan", "tanggal_efektif","tanggal_akhir_efektif","updated_at" ,"created_at","created_by", "update_by"
    ];
