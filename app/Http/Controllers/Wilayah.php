...
class Wilayah extends Controller
            ...
            "title"=>["type"=>"null" , "value"=>"null" , "validation" => ""] ,
                ...
                static $tablename = "Wilayah";
                public function index()
                {
                    $data = WilayahModel::get();
                    $title = ucfirst(request()->segment(1))." ".ucfirst(request()->segment(2));
                    $tableid = "Wilayah";
                    $table_display = DB::getSchemaBuilder()->getColumnListing("master_wilayah");
                ...
                public function sinc(){
                    ...
                    $data = array('act'=>"GetWilayah" , "token"=>$token, "filter"=> "","limit"=>"" , "offset" =>0);
                    ...
                    if(array_key_exists('data' , $result)){
                        if(count($result['data']) > 0){
                            ...
                            try{
                                ...
                                ->insert(array('title' => 'GetWilayah' ,'created_by'=> Auth::user()->id ,'created_at'=>date('Y-m-d H:i:s')));
                ...
                public function create(){
                    ...
                    $table = array_diff(DB::getSchemaBuilder()->getColumnListing("master_wilayah"), static::$exclude);
                    $exclude = static::$exclude;
                    $Tableshow = static::$Tableshow;
                    $html = static::$html;
                    $column = 1;
                ...
                public function save(Request $request){
                    ...
                    $field = [];
                    $data = [];
                    $table = DB::getSchemaBuilder()->getColumnListing("master_wilayah");
                    ...
                    $save  = WilayahModel::firstOrCreate($data);
                    if($save){
                ...
                public function paging(Request $request){
                    return Datatables::of(WilayahModel::all())->make(true);
                }
