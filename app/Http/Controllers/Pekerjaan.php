...
class Pekerjaan extends Controller
            {
                ...
                public function sinc(){
                    ...
                    if(!$result){
                        $this->sinkron_log('sync_pekerjaan','gagal', 0);
                        ...
                        if($result['data']) {
                            if (count($result['data']) > 0) {
                                ...
                                try {
                                    ...
                                    DB::commit();
                                    $this->sinkron_log('sync_pekerjaan','sukses', count($result['data']));
                                    DB::table('sinkronisasi_logs')
                                        ->insert(array('title' => 'GetPekerjaan', 'created_by' => Auth::user()->nama, 'created_at' => date('Y-m-d H:i:s')));
