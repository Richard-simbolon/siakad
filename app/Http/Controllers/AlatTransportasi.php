...
class AlatTransportasi extends Controller
            {
                ...
                {
                    $data = AlatTransportasiModel::get();
                    $title = ucfirst(request()->segment(1))." ".ucfirst(request()->segment(2));
                    $tableid = "AlatTransportasi";
                    $table_display = DB::getSchemaBuilder()->getColumnListing("master_alat_transportasi");
                ...
                public function sinc(){
                    ...
                    //echo $token; exit;
                    $data = array('act'=>"GetAlatTransportasi" , "token"=>$token, "filter"=> "","limit"=>"" , "offset" =>0);
                ...
                public function create(){
                    ...
                    $table = array_diff(DB::getSchemaBuilder()->getColumnListing("master_alat_transportasi"), static::$exclude);
                    $exclude = static::$exclude;
                    $Tableshow = static::$Tableshow;
                    $html = static::$html;
                    $column = 1;
                ...
                public function save(Request $request){
                    ...
                    $field = [];
                    $data = [];
                    $table = DB::getSchemaBuilder()->getColumnListing("master_alat_transportasi");
                ...
                public function view($id){
                    $data = AlatTransportasiModel::where('id' , $id)->first();
                ...
                public function update(Request $request){
                    ...
                    $data =  AlatTransportasiModel::where('id' , $request->id)->first();
                    $data->title = $request->title;
                    $data->row_status = $request->row_status;

                    $data->save();
                    return redirect('/master/alattransportasi');
                }
                ...
                public function paging(Request $request){
                    return Datatables::of(AlatTransportasiModel::where('row_status', '!=', 'deleted')->get())->addIndexColumn()->make(true);
                }
