                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="title" placeholder="Isikan Judul" value="{{$data['title']}}" disabled="disabled" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-4">
                                                        <label>Tanggal</label>
                                                        <div class="form-group">
                                                            <input type="date" style="letter-spacing: 1px" class="form-control" name="start" value="{{date('Y-m-d', strtotime($data['start']))}}" disabled="disabled"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <label>Jam</label>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control time-picker" name="time_start" value="{{$data['time_start']}}" disabled="disabled"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-4">
                                                        <label>Tanggal</label>
                                                        <div class="form-group">
                                                            <input type="date" style="letter-spacing: 1px" class="form-control" name="end" value="{{date('Y-m-d', strtotime($data['end']))}}" disabled="disabled"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <label>Jam</label>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control time-picker" name="time_end" value="{{$data['time_end']}}" disabled="disabled"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-4">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control" name="warna" disabled="disabled" >
                                                    ...
                                                    <div class="col-xl-4">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control" name="display" disabled="disabled" >
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="summernote" name="keterangan" readonly>{{$data['keterangan']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
