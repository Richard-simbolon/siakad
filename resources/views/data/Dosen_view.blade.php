                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                            <ul class="kt-nav">
                                <li class="kt-nav__item">
                                    <a href="layout/skins/dosen-view-edit.html" class="kt-nav__link">
                                        <i class="kt-nav__link-icon flaticon2-user"></i>
                                        <span class="kt-nav__link-text">Detail Dosen</span>
                                    </a>
                                </li>
                                <li class="kt-nav__item">
                                    <a href="layout/skins/dosen-penugasan.html" class="kt-nav__link">
