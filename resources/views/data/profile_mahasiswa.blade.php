                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="kt-checkbox-inline">
                                                            <label class="kt-radio">
                                                                <input type="radio" name="jk" value="{{$data['jk']}}" {{$data['jk']=='L' ? 'checked':''}}> Laki-laki
                                                                <span></span>
                                                            </label> &nbsp;
                                                            <label class="kt-radio">
                                                                <input type="radio" name="jk" value="{{$data['jk']}}" {{$data['jk']=='P' ? 'checked' :''}}> Perempuan
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="kt-form__actions">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <button type="button" id="btn_edit_profile" class="btn btn-outline-success"><i class="fa fa-save"></i> Simpan Perubahan</button>&nbsp;
                                                </div>
                                            </div>
                                        </div>
                                    </div>
