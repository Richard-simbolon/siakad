                            ...
                            <form class="kt-form kt-form--label-right" action="save" method="POST">
                                ...
                                <div class="kt-portlet__body">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" onchange="get_mahasiswa($(this))" id="nim" class="form-control" placeholder="Cari Berdasarkan NIM">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{$semester->title}}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="kt-form__actions">
                                        ...
                                        <a style="color:#ffffff;" data-prev-url="{{url()->previous()}}" class="btn btn-success" id="save_aktivitas_perkuliahan">
