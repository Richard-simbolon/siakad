            ...
            <div class="modal-content">
                ...
                <form class="kt-form" id="penugasanform" style="">
                                            ...
                                            <div class="kt-portlet__body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="perguruan_tinggi" placeholder="Isikan Nama Perguran Tinggi">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            <label>Gelar</label>
                                                            <input type="text" class="form-control" name="gelar" placeholder="Isikan Gelar">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger savependidikan">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
