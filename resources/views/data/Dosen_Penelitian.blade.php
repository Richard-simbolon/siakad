                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="judul_penelitian" placeholder="Isikan Judul Penelitian">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            <label>Bidang Ilmu</label>
                                                            <input type="text" class="form-control" name="bidang_ilmu" placeholder="Isikan Bidang Ilmu">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            <label>Lembaga</label>
                                                            <input type="text" class="form-control" name="lembaga" placeholder="Isikan Lembaga">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
