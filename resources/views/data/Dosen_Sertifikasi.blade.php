            ...
            <div class="modal-content">
                ...
                <form class="kt-form" id="penugasanform" style="">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="nomor" placeholder="Isikan No Peserta">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            <label>Bidang Studi</label>
                                                            <input type="text" class="form-control" name="bidang_studi" placeholder="Isikan Bidang Studi">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="jenis_sertifikasi" placeholder="Isikan Jenis Sertifikasi">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            <label>Tahun Sertifikasi</label>
                                                            <input type="date" class="form-control" name="tahun_sertifikasi" placeholder="Isikan Tahun Sertifikasi">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="no_sk_sertifikasi" placeholder="Isikan Nomor Sertifikasi">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="root">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger savesertifikasi">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
