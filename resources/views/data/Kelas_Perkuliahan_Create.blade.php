                    ...
                    <div class="kt-portlet__body">
                        <div class="row">
                            <div class="col-xl-4">
                                ...
                                <div class="form-group">
                                    <select name="semester" id="search-semester" class="form-control kt-select2">
                            ...
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <select name="angkatan" id="search-angkatan" class="form-control kt-select2">
                                        <option value="">Select</option>
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                ...
                                <div class="form-group">
                                    <select name="jurusan_id" id="jurusan" class="form-control kt-select2">
                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="form-group">
                                    <select name="kelas" id="kelas" class="form-control kt-select2">
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <button type="button" class="btn btn-success btn-sm"><i class="flaticon2-plus"></i> Tambah Matakuliah</button>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12">
                                <table class="table table-striped table-bordered table-hover responsive" id="kt_table_1">
                                    ...
                                    <tr>
                                        ...
                                        <td>MK001</td>
                                        <td style="vertical-align: center;">Pengantar Bibit</td>
                                        <td align="center">3</td>
                                        <td align="center">1</td>
                                        <td>
                                            <select class="form-control form-control-sm">
                                                <option>Nama Dosen A</option>
                                                <option>Nama Dosen B</option>
                                                <option>Nama Dosen C</option>
                                                <option>Nama Dosen D</option>
                                                <option>Nama Dosen E</option>
                                                <option>Nama Dosen F</option>
                                                <option>Nama Dosen G</option>
                                                <option>Nama Dosen H</option>
                                            </select>
                                        </td>
                                        <td align="center"><input type="text" name="asisten" class="form-control form-control-sm" /> </td>
                                        <td align="center">
                                            <select class="form-control form-control-sm">
                                                <option>Senin</option>
                                        ...
                                        <td align="center"><input type="text" name="jam" class="form-control form-control-sm" /> </td>
                                    </tr>
                                    <tr>
                                        <td align="center"><input type="checkbox" class="form-control-sm"></td></td>
                                        <td>MK001</td>
