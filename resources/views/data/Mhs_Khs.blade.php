                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            ...
                            <button type="button" class="btn btn-outline-success" onclick="window.location.href='{{url('admin/print_khs')}}/'+$('#admin-search-khs').val()+'/'+{{$mahasiswa->id}}"><i class="la la-print"></i> Cetak KHS</button>
                            </div>
                        </div>
                    </div>
                    <!--begin::Form-->
                                ...
                                <div class="col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="semester_id" id="admin-search-khs" class="form-control kt-select2 search-nilai-matakuliah looping_class_input">
