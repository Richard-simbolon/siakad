                ...
                <div class="col-xl-12 order-lg-1 order-xl-1">
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            <form id="form_upload_soal" enctype="multipart/form-data" class="kt-form kt-form--label-right" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="jenis_ujian" id="jenis_ujian" class="form-control kt-select2">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="jurusan_id" id="jurusan-mahasiswa" class="form-control kt-select2">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="semester_id" class="form-control kt-select2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Kelas</label>
                                            <select name="kelas_id" id="kelas-mahasiswa" class="form-control kt-select2">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="mata_kuliah_id" class="form-control kt-select2">
