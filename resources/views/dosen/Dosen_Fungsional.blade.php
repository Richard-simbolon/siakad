            ...
            <div class="modal-content">
                ...
                <form class="kt-form" id="penugasanform" style="">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            <label>Jabatan</label>
                                                            <input type="text" class="form-control" name="jabatan" placeholder="Isikan Nama Jabatan">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="form-group">
                                                            <label>SK Jabatan</label>
                                                            <input type="text" class="form-control" name="sk_jabatan" placeholder="Isikan SK Jabatan">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success dosensavefungsional">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
