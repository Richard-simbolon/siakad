                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Nama</label>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control required" value="{{$data->nama}}" name="nama" placeholder="Isikan Nama" title="Kode Mata Harus Diisi" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Nama</label>
                                                    <select name="status" class="form-control" id="status_admin">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" value="{{$data->telp}}" name="telp" placeholder="Isikan Telepon/HP">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>NIP</label>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="nip" value="{{$data->nip}}" placeholder="Isikan Nip" required>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text"  class="form-control" readonly value="{{$data->username}}" name="username" id="bobot_tatap_muka" placeholder="Isikan username">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>email</label>
                                                    <div class="form-group">
                                                        <input type="email" class="form-control" value="{{$data->email}}" name="email" min="0" placeholder="Isikan email">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
